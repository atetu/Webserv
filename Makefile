...
TARGET					= webserv
SOURCES					= ./config/block/CGI.cpp ./config/block/LocationBlock.cpp ./config/block/MimeBlock.cpp ./config/block/RootBlock.cpp ./config/block/ServerBlock.cpp ./config/Configuration.cpp ./exception/Exception.cpp ./exception/IllegalArgumentException.cpp ./exception/IllegalStateException.cpp ./exception/IOException.cpp ./exception/NoSuchElementException.cpp ./exception/NullPointerException.cpp ./exception/RuntimeException.cpp ./http/handler/methods/ConnectHandler.cpp ./http/handler/methods/DeleteHandler.cpp ./http/handler/methods/GetHandler.cpp ./http/HTTP.cpp ./http/HTTPClient.cpp ./http/HTTPDate.cpp ./http/HTTPHeaderFields.cpp ./http/HTTPMethod.cpp ./http/HTTPOrchestrator.cpp ./http/HTTPRequest.cpp ./http/HTTPRequestParser.cpp ./http/HTTPResponse.cpp ./http/HTTPServer.cpp ./http/HTTPStatus.cpp ./http/HTTPVersion.cpp ./http/mime/Mime.cpp ./http/mime/MimeRegistry.cpp ./io/Socket.cpp ./io/SocketServer.cpp ./server/WebServer.cpp ./util/buffer/IOBuffer.cpp ./util/Closable.cpp ./util/json/JsonArray.cpp ./util/json/JsonBoolean.cpp ./util/json/JsonEnumValues.cpp ./util/json/JsonException.cpp ./util/json/JsonLocation.cpp ./util/json/JsonNull.cpp ./util/json/JsonObject.cpp ./util/json/JsonParseException.cpp ./util/json/JsonParser.cpp ./util/json/JsonReader.cpp ./util/json/JsonTokenizer.cpp ./util/json/JsonUtils.cpp ./util/json/JsonValue.cpp ./util/log/Logger.cpp ./util/log/LoggerFactory.cpp ./util/log/LoggerImpl.cpp ./util/log/LogLevel.cpp ./util/Objects.cpp ./util/options/ParserException.cpp ./util/System.cpp ./util/unit/DataSize.cpp ./util/unit/DataUnit.cpp ./util/URL.cpp ./webserv.cpp
